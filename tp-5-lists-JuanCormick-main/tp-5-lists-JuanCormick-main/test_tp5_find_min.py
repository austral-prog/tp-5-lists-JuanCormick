import unittest
import exercise_find_min as ex
...
class TestFindMin(unittest.TestCase):
    ...
    def test_lista_decimales(self):
        ...
        result = ex.find_min([3.14, 2.71, 9.99, 1.41])
        self.assertEqual(1.41, result)
